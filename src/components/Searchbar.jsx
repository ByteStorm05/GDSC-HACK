...
const SearchBar = ({ onSearch }) => {
  ...
  // Flatten the list of cities using useMemo for optimization
  const cities = useMemo(() => Object.values(cityList).flat(), [cityList]);
            ...
            <div className="relative">
              <div className="flex">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setGuestCount(
                      Math.max(1, parseInt(e.target.value) || 1) // Ensure valid input
                    )
                  }
                  min="1"
                  className="w-full p-2 border-t border-b text-center focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
