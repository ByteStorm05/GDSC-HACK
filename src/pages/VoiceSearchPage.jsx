...
import AmenityVoiceInput from '@/components/Voice2';
...
const ChatPage = () => {
  ...
  return (
    <div>
      <AmenityVoiceInput setAmenitiesList={setAmenitiesList} />

      {/* Optionally, show the amenities list */}
      {amenitiesList && (
        <div style={{ marginTop: '20px' }}>
          <strong>Selected Amenities:</strong>
          <pre>{amenitiesList}</pre>
        </div>
      )}
